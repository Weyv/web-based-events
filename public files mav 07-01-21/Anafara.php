...
<body>
	...
	<!--- Anafara Button w link -->
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-10 py-5">
				<h2>Anafara</h2>
				<p class="lead">Anafara Products Trading offers various cosmetic offer for Business Rebranding or Retail.</p><a class="btn btn-purple btn-lg" href="https://www.facebook.com/AnafaraProductsTrading/" target="_blank">Visit us!</a>
			</div>
		</div>
	</div>
	<!--- End Anafara Button w link -->
